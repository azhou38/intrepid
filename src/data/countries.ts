...
export const ALL_COUNTRIES: Country[] = [
  ...
  { code: 'AO', name: 'Angola' }, { code: 'AG', name: 'Antigua & Barbuda' },
  ...
  { code: 'CD', name: 'Congo (DRC)' }, { code: 'CG', name: 'Congo (Rep.)' },
  ...
  { code: 'VC', name: 'Saint Vincent' }, { code: 'WS', name: 'Samoa' },
  ...
  { code: 'TT', name: 'Trinidad & Tobago' }, { code: 'TN', name: 'Tunisia' },
  ...
  // Territories & special regions commonly visited
  { code: 'HK', name: 'Hong Kong' }, { code: 'MO', name: 'Macau' },
  { code: 'PR', name: 'Puerto Rico' }, { code: 'PF', name: 'French Polynesia' },
  { code: 'NC', name: 'New Caledonia' }, { code: 'FO', name: 'Faroe Islands' },
  { code: 'GL', name: 'Greenland' }, { code: 'CK', name: 'Cook Islands' },
  { code: 'GI', name: 'Gibraltar' }, { code: 'CW', name: 'Curaçao' },
];
