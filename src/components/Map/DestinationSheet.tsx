...
// ── Spot grid card — same visual language as HighlightCard (photo, name,
// bio) but flex-basis'd for a 2-column wrapping grid instead of horizontal scroll.
  ...
  return (
    <View style={st.backdrop} pointerEvents="box-none">
      ...
      <Reanimated.View style={[st.sheet, sheetAnimStyle]}>
        ...
        >
          <Pressable style={StyleSheet.absoluteFill} onPress={() => snapToCollapsedRef.current()}>
            {photoUrl && <FadeInImage instant source={{ uri: photoUrl }} style={StyleSheet.absoluteFill} resizeMode="cover" />}
